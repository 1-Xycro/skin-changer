...
mp7 = gg.getResults(100)
 ...
 gg.searchNumber("44200000BA200000r;BA20000016210000r;16210000BF210000r;BF2100009E220000r;9E22000019230000r;19230000ED240000r;ED24000000000000r",gg.TYPE_QWORD)
gg.getResults(100)
gg.refineNumber("ED24000000000000r",gg.TYPE_QWORD)
...
if gg.isPackageInstalled("sstool.only.com.sstool") then
 ...
 function HOME()
 gg.toast('ʙʏ: 𝟎𝟕𝟕 𝕴𝖈𝖊𝖒𝖔𝖉𝖘#0777 & ᴀʀꜱᴋɪᴢ#3864 & xʏᴄʀᴏ#8113')
       Mn = gg["multiChoice"]({
         "『🧤』 | sᴋɪɴ ᴄʜᴀɴɢᴇʀ",
         "『👨‍💻』 | ᴄʜᴇᴀᴛꜱ    ",
		 "『♻️』 | ᴄʜᴇᴄᴋ ꜰᴏʀ ᴜᴘᴅᴀᴛᴇ   ",
...
>────────────< ]])))
 ...
 function Insta()
 Config = gg.prompt({"Arskizz","Crez","Twist"},nil,{"checkbox","checkbox","checkbox"})
...
if Config == nil then gg.alert("Canceled!") end
end
